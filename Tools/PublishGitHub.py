...
def main(argv):
  ...
  parser.add_argument(
      ...
      help='''the main archive file to publish.''')
  parser.add_argument(
      ...
      help='''the RegExp to extract the version tag from the archive name.
          [Default: %(default)s]''')
  parser.add_argument(
      '--add_file', action='store', metavar='<file path>', nargs='+',
      help='''extra files to be added into the release. Specify multiple
          parameters if multiple files need to be added.''')
  parser.add_argument(
