...
/// <summary>Utility class to load Unity assets and bundles into the game in runtime.</summary>
/// <remarks>
/// This module works best in conjunction with the <c>UnityDev</c> library. The dynamic assets can
/// be loaded via this utility, and <c>UnityDev</c> can be used to retrieve the assets.
/// </remarks>
/// <seealso href="https://github.com/ihsoft/UnityDev"/>
