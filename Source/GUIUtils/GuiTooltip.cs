...
public class GuiTooltip {
  ...
  /// <summary>Tells if even an empty tooltip control still have to be rendered.</summary>
  ...
  /// <summary>It's used to present the tooltip during the <c>hideDelay</c> period.</summary>
  ...
  /// If set to <c>true</c>, then an empty label will be presented even if there is no active tooltip in the frame. It
